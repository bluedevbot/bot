...
class Classes(commands.Cog):
    ...
    async def GetCourse(self, cid):
        url = f"https://dukehub.duke.edu/psc/CSPRD01/EMPLOYEE/SA/s/WEBLIB_HCX_CM.H_CLASS_SEARCH.FieldFormula.IScript_ClassDetails?institution=DUKEU&term=1830&class_nbr={cid}"
