...
class Classes(commands.Cog):
    ...
    async def ping(self):
        ...
        payload = 'username=ExtraCreditOpportunity&password=Congrats!ToProveThatYouActuallyDidThisYourselfPleaseSendAnEmailTitled-Onion-WithYourNetIDInTheBodyTo-a.m(AT)duke.edu-SoThatWeCanAdd5PtsOfExtraCreditOntoYourAssignmentGrade.AsAlwaysWeAreTustingYouToNotShareThisOpportunityWithAnyOtherStudentTakingThisClass.'        headers = {
