...
courses = [
    "Courses", 1065361477768319076, 1, 
    ["chem-101", 997217964795383818, "🧪", 1],
    ["chem-201",1065653264135241748,"⚗️",1],
    ["psy-101", 997218047297323059, "🧠", 1],
    ["econ-201", 997224230326386728, "🪙", 1],
    ["econ-104",1065653338915483778,"💷",1],
    ["econ-201",1065653429101400087,"💹",1],
    ["econ-210",1065653901279363194,"🏦",1],
